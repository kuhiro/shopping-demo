...
var MinimumCategoryAndManufacturerCount = 25;
...
function render_purchase(sid, username, idata) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    var isrc   = item.image_src;
    html      += '<span style="padding: 5px 20px;">&nbsp</span>' +
                 '<img src="' + isrc + '" width=30 height=30'    +
                 ' style="vertical-align:middle"/>'              +
    ...
    if (gerr) next(gerr, null);
      ...
      if (!pdata) {
        ...
        var html   = '<table width="750" style="border: 1px solid black;">' +
                     ...
                     "</td>" +
                     '<td width="250">' +
                     '<img src="' + pdata.image_src + '" width=200 height=200' +
...
function create_product_summary(sid, short, show, pdata) {
  ...
  var isrc  = '<img src="' + pdata.image_src + '" width=30 height=30' +
              ' style="vertical-align:middle"/>';
  var html  = (show ? "" : isrc) +
              '<span style="padding: 5px 20px;">' +
