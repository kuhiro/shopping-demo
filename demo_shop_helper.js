...
// NOTE: URL: https://www.kuhiro.com/static/demo_shop_helper.js
...
function client_change_domain(val, cname, t, pn) {
  var loc   = window.location;
  var do_pn = (typeof(pn) !== "undefined");
  var search;
  if (!loc.search) {
    search = '?customer=' + cname;
    if (do_pn) search += "&pop=" + pn;
  } else {
    search = loc.search;
    search = client_require_query_variable(search, "customer", cname);
    if (do_pn) search = client_require_query_variable(search, "pop", pn);
  }
